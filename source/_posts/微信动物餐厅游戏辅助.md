...
categories:
  - 其他
date: 2019-06-17 11:40:00
---
最近迷上了微信小游戏里面的动物餐厅,每次刷任务太麻烦了就用auto.js写了一个辅助工具

# 源码 [GitHub](https://github.com/chuanshuo843/WxAnimalTools)
...
var Animal = function(){
    ...
    this.clickPropaganda = (number) => {
        ...
        for(var i = 0;i<number;i++){
            ...
            this.ra.press(device.width-150, device.height-170,3000,FINGER_2);
        }
    }
